#!/public/home/htaohan/software/Anaconda3-5.0.0/envs/concoct_env/bin/python
...
def main(args):
    ...
    try:
        assert df.columns[0] == 'binnew'
        assert df.columns[1] == 'contig'
    ...
    for i, row in df.iterrows():
        cluster_to_contigs[row['binnew']].append(row['contig'])
