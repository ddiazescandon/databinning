...
def gen_X(com_file, cov_file):
    ...
    print(f"len_namelist:{len(namelist)}")
    ...
    print(f"covIdxArr:{covIdxArr}")
    print(f"shuffled_compositMat:{shuffled_compositMat}")
    print(f"covIdxArr:{covIdxArr.shape}")
    print(f"shuffled_compositMat:{shuffled_compositMat.shape}")
