...
def go(ax, num_rows):
    ...
    for k in range(10):
        ...
        if i==0 and j==0:
            ...
            ax[i, j].bar(0 + .15, 111, width=.3, color=cat_colors[4] , label='MAGScoT')
        ...
        #MARINE HQ
            ...
            ax[i, j].bar(0 + .15, 8, width=.3, color=cat_colors[4])
        ...
        #CHEESE NC
            ...
            ax[i, j].bar(0 + .15, 31, width=.3, color=cat_colors[4] )
        ...
        #CHEESE HQ
            ...
            ax[i, j].bar(0 + .15, 3, width=.3, color=cat_colors[4] )
        ...
        #HUMAN GUT I NC
            ...
            ax[i, j].bar(0 + .15, 57, width=.3, color=cat_colors[4])
        ...
        #HUMAN GUT I HQ
            ...
            ax[i, j].bar(0 - .15, 2, width=.3, color=cat_colors[3])
            ax[i, j].bar(0 + .15, 4, width=.3, color=cat_colors[4] )
        ...
        #HUMAN GUT II NC
            ...
            ax[i, j].bar(0 + .15, 159, width=.3, color=cat_colors[4])
        ...
        #HUMAN GUT II HQ
            ...
            ax[i, j].bar(0 + .15, 16, width=.3, color=cat_colors[4] )
...
def main():
    ...
    fig.savefig('./MAGScoT_new.pdf', dpi=300, format='pdf', bbox_inches='tight')
    plt.close()
