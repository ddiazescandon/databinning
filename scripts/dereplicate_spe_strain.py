    ...
    for k in range(4):
        ...
        if i==0 and j== 0:
            ax[i, j].bar(0 - .2, 131, width=.2, color=cat_colors[0],
                   label='Short_co')
            ax[i, j].bar(0, 91, width=.2, color=cat_colors[1],
                   label='Short_single')
            ...
            ax[i, j].bar(1 - .1, 70, width=.2, color=cat_colors[3],
                   label='Long_single')
            ax[i, j].bar(1 + .1, 95, width=.2, color=cat_colors[4],
                   label='Long_multi')
            ...
            ax[i, j].bar(0 - .2, 131, width=.2, color=cat_colors[0],
                   label='Short_co')
            ax[i, j].bar(0, 140, width=.2, color=cat_colors[1],
                   label='Short_single')
            ...
            ax[i, j].bar(1 - .1, 70, width=.2, color=cat_colors[3],
                   label='Long_single')
            ax[i, j].bar(1 + .1, 97, width=.2, color=cat_colors[4],
                   label='Long_multi')
            ...
            ax[i, j].bar(0 - .2, 13, width=.2, color=cat_colors[0],
                   label='Short_co')
            ax[i, j].bar(0, 22, width=.2, color=cat_colors[1],
                   label='Short_single')
            ...
            ax[i, j].bar(1- .1, 67, width=.2, color=cat_colors[3],
                   label='Long_single')
            ax[i, j].bar(1 + .1, 93, width=.2, color=cat_colors[4],
                   label='Long_multi')
            ...
            ax[i, j].bar(0 - .2, 13, width=.2, color=cat_colors[0],
                   label='Short_co')
            ax[i, j].bar(0, 29, width=.2, color=cat_colors[1],
                   label='Short_single')
