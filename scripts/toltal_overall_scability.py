...
#
data_time = pd.read_csv('time_mem/time_new.txt', sep='\t', index_col=0, encoding='utf-8')
data_time = data_time[::-1]
std_time = pd.read_csv('time_mem/time_std.txt', sep='\t', index_col=0, encoding='utf-8')
std_time = std_time[::-1]
data_all_time = pd.read_csv('time_mem/time_all.txt', sep='\t', index_col=0, encoding='utf-8')
...
#
data_time = pd.read_csv('time_mem/mem_new.txt', sep='\t', index_col=0, encoding='utf-8')
data_time = data_time[::-1]
data_std = pd.read_csv('time_mem/mem_std.txt', sep='\t', index_col=0, encoding='utf-8')
data_std = data_std[::-1]
data_all_time = pd.read_csv('time_mem/mem_all.txt', sep='\t', index_col=0, encoding='utf-8')
data_all_time = data_all_time[::-1]
