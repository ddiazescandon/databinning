...
def main():
    ...
    subset1 = pd.DataFrame(
        [(190-92-59, 92, 59), (216-80-85, 80, 85), (151-16-55, 16, 55), (95-9-25, 9, 25), (164-7-27, 7, 27)],
    ...
    subset2 = pd.DataFrame(
        [(247-93-116, 93, 116), (314-83-183, 83, 183), (260-31-108, 31, 108), (96-9-26, 9, 26), (402-30-102, 30, 102)],
        index=['Short_co_single', 'Short_co_multi', 'Short_single_multi', 'Long_single_multi', 'Hybrid_single_multi'],
        columns=['Both', 'previous only', 'before only'])

    subset3 = pd.DataFrame(
        [(28-7-15, 7, 15), (37-7-24, 7, 24), (34-4-13, 4, 13), (93-11-26, 11 , 26), (126-11-17, 11, 17)],
        index=['Short_co_single', 'Short_co_multi', 'Short_single_multi', 'Long_single_multi', 'Hybrid_single_multi'],
        columns=['Both', 'previous only', 'before only'])

    subset4 = pd.DataFrame(
        [(36-7-23, 7, 23), (56-7-43, 7, 43), (54-6-29, 6, 29), (94-11-27, 11, 27), (279-24-70, 24, 70)],
        index=['Short_co_single', 'Short_co_multi', 'Short_single_multi', 'Long_single_multi', 'Hybrid_single_multi'],
        columns=['Both', 'previous only', 'before only'])
